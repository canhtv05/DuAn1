...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private EventCalendar getEventDay(Dates dates) {
    ...
    private EventCalendar getEventMonth() {
        return (MouseEvent evt, int num) -> {
            MONTH = num;
            selectedDate.setDay(DAY);
            selectedDate.setMonth(MONTH);
    ...
    private EventCalendar getEventYear() {
        return (MouseEvent evt, int num) -> {
            YEAR = num;
            selectedDate.setDay(DAY);
            selectedDate.setMonth(MONTH);
    ...
    private void initComponents() {
        ...
        cmdForward = new view.component.calendar.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new view.component.calendar.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new view.component.calendar.Button();
        cmdPrevious = new view.component.calendar.Button();
        slide = new view.panel.Slider();
    ...
    private view.component.calendar.Button cmdForward;
    private view.component.calendar.Button cmdMonth;
    private view.component.calendar.Button cmdPrevious;
    private view.component.calendar.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private view.panel.Slider slide;
