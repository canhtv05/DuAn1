...
import view.component.calendar.Button;
import service.EventCalendar;
...
public final class Dates extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMo = new view.component.calendar.Button();
        cmdTu = new view.component.calendar.Button();
        cmdWe = new view.component.calendar.Button();
        cmdTh = new view.component.calendar.Button();
        cmdFr = new view.component.calendar.Button();
        cmdSa = new view.component.calendar.Button();
        cmdSu = new view.component.calendar.Button();
        cmd1 = new view.component.calendar.Button();
        cmd2 = new view.component.calendar.Button();
        cmd3 = new view.component.calendar.Button();
        cmd4 = new view.component.calendar.Button();
        cmd5 = new view.component.calendar.Button();
        cmd6 = new view.component.calendar.Button();
        cmd7 = new view.component.calendar.Button();
        cmd8 = new view.component.calendar.Button();
        cmd9 = new view.component.calendar.Button();
        cmd10 = new view.component.calendar.Button();
        cmd11 = new view.component.calendar.Button();
        cmd12 = new view.component.calendar.Button();
        cmd13 = new view.component.calendar.Button();
        cmd14 = new view.component.calendar.Button();
        cmd15 = new view.component.calendar.Button();
        cmd16 = new view.component.calendar.Button();
        cmd17 = new view.component.calendar.Button();
        cmd18 = new view.component.calendar.Button();
        cmd19 = new view.component.calendar.Button();
        cmd20 = new view.component.calendar.Button();
        cmd21 = new view.component.calendar.Button();
        cmd22 = new view.component.calendar.Button();
        cmd23 = new view.component.calendar.Button();
        cmd24 = new view.component.calendar.Button();
        cmd25 = new view.component.calendar.Button();
        cmd26 = new view.component.calendar.Button();
        cmd27 = new view.component.calendar.Button();
        cmd28 = new view.component.calendar.Button();
        cmd29 = new view.component.calendar.Button();
        cmd30 = new view.component.calendar.Button();
        cmd31 = new view.component.calendar.Button();
        cmd32 = new view.component.calendar.Button();
        cmd33 = new view.component.calendar.Button();
        cmd34 = new view.component.calendar.Button();
        cmd35 = new view.component.calendar.Button();
        cmd36 = new view.component.calendar.Button();
        cmd37 = new view.component.calendar.Button();
        cmd38 = new view.component.calendar.Button();
        cmd39 = new view.component.calendar.Button();
        cmd40 = new view.component.calendar.Button();
        cmd41 = new view.component.calendar.Button();
        cmd42 = new view.component.calendar.Button();
    ...
    public void setEvent(EventCalendar event) {
        this.event = event;
        addEvent();
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private view.component.calendar.Button cmd1;
    private view.component.calendar.Button cmd10;
    private view.component.calendar.Button cmd11;
    private view.component.calendar.Button cmd12;
    private view.component.calendar.Button cmd13;
    private view.component.calendar.Button cmd14;
    private view.component.calendar.Button cmd15;
    private view.component.calendar.Button cmd16;
    private view.component.calendar.Button cmd17;
    private view.component.calendar.Button cmd18;
    private view.component.calendar.Button cmd19;
    private view.component.calendar.Button cmd2;
    private view.component.calendar.Button cmd20;
    private view.component.calendar.Button cmd21;
    private view.component.calendar.Button cmd22;
    private view.component.calendar.Button cmd23;
    private view.component.calendar.Button cmd24;
    private view.component.calendar.Button cmd25;
    private view.component.calendar.Button cmd26;
    private view.component.calendar.Button cmd27;
    private view.component.calendar.Button cmd28;
    private view.component.calendar.Button cmd29;
    private view.component.calendar.Button cmd3;
    private view.component.calendar.Button cmd30;
    private view.component.calendar.Button cmd31;
    private view.component.calendar.Button cmd32;
    private view.component.calendar.Button cmd33;
    private view.component.calendar.Button cmd34;
    private view.component.calendar.Button cmd35;
    private view.component.calendar.Button cmd36;
    private view.component.calendar.Button cmd37;
    private view.component.calendar.Button cmd38;
    private view.component.calendar.Button cmd39;
    private view.component.calendar.Button cmd4;
    private view.component.calendar.Button cmd40;
    private view.component.calendar.Button cmd41;
    private view.component.calendar.Button cmd42;
    private view.component.calendar.Button cmd5;
    private view.component.calendar.Button cmd6;
    private view.component.calendar.Button cmd7;
    private view.component.calendar.Button cmd8;
    private view.component.calendar.Button cmd9;
    private view.component.calendar.Button cmdFr;
    private view.component.calendar.Button cmdMo;
    private view.component.calendar.Button cmdSa;
    private view.component.calendar.Button cmdSu;
    private view.component.calendar.Button cmdTh;
    private view.component.calendar.Button cmdTu;
    private view.component.calendar.Button cmdWe;
