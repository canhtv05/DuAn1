...
import static view.jframe.LuaChonNgayXuatExcel.ngayXuatString;

public class LuaChonNgayXuatPDF extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        myButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8_export_pdf_24px.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LuaChonNgayXuatPDF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
